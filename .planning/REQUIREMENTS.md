...
- [x] **GRAPH-01**: 用户可在公司详情页看到交互式节点网络图，展示该公司的董事、股东和关联 ICIJ 离岸实体
- [x] **GRAPH-02**: 用户可点击网络图中的任意节点，跳转到该实体的 ETI 详情页（若该实体存在于 ETI 数据库中）
- [x] **GRAPH-03**: 网络图追踪至多 3 跳的所有权/董事关系链（节点上限 100），通过 PostgreSQL WITH RECURSIVE CTE 实现
- [x] **GRAPH-04**: 网络图使用颜色编码区分节点风险类型：红=制裁实体，橙=欺诈预警实体，灰=ICIJ 离岸实体，蓝=正常实体
