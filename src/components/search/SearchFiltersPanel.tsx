...
// Glow colors for card hover effect — translucent version of each risk colour
    ...
    <li>
      <Link
        ...
        style={{
          ...
          textDecoration: 'none',
          gap: 'var(--space-4)',
          ['--card-risk-glow' as string]: RISK_GLOW[result.riskLevel] ?? 'transparent',
        }}
      >
        {/* Left: name + meta */}
        ...
        <div style={{ flexShrink: 0, display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '6px' }}>
          ...
          <span style={{ fontSize: '11px', color: 'var(--text-muted)' }}>
            ...
            <strong style={{
              ...
              <AnimatedScore value={result.authenticityScore} />
            </strong>
            {' '}
