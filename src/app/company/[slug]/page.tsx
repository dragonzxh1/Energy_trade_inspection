...
export default async function CompanyPage({ params }: PageProps) {
  ...
  // The website field is populated for seed entities and can be set by sync modules.
  // For entities without a stored domain, DomainIntelPanel shows a manual input form.
  const companyDomain: string | null = company.website ?? null
