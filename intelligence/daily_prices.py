...
from intelligence.summary_image_support import PlattsSummaryTrialResult
...
def promote_summary_image_quote(
    ...
    *,
    ...
    from intelligence.summary_image_support import detect_market_date_from_image_title
